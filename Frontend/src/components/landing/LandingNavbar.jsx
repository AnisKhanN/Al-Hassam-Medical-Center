...
const NAV_LINKS = [
  ...
  { id: "faq", label: "FAQ", href: "#faq", anchor: "#faq", icon: FiHelpCircle },
  {
    id: "docs",
    label: "Docs & Reports",
    href: "/docs",
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-3">
            ...
            if (link.isRoute) {
              return (
                <div
                  key={link.href}
                  className="relative"
                  ref={link.id === "docs" ? dropdownRef : null}
                  onMouseEnter={
                    link.id === "docs"
                  ...
                  onMouseLeave={
                    link.id === "docs" ? handleDocsMouseLeave : undefined
                  }
                >
                  {link.id === "docs" ? (
                    <button
        ...
        {/* Desktop Right Actions: Theme Switcher & Auth State */}
        <div className="hidden sm:flex items-center gap-2.5">
          ...
          {user ? (
            ...
            >
              ...
              {userDropdownOpen && (
                <div
                  className="absolute right-0 top-full mt-2 w-64 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-2 shadow-xl backdrop-blur-md z-50 animate-in fade-in slide-in-from-top-2 duration-150"
                  onMouseEnter={handleUserMouseEnter}
                  onMouseLeave={handleUserMouseLeave}
                >
                  {/* User Profile Card */}
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-0 right-0 top-[60px] max-h-[85vh] overflow-y-auto bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 px-5 py-6 shadow-2xl z-50 lg:hidden space-y-5"
            >
